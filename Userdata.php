...
<?php 
// Backend:
// Skal hente alle end infomationer så man kan ændre dem alle sammen.
?>
<html>
<head>
	<title></title>
...
<form action="FrontPage.php">
	<center>
		<!-- Alle placeholders skal være det der står i databasen -->
	...
	<!-- Update databasen --->
	<button type="submit"> Update Bruger </button>
</form>
<form action="FrontPage.php">
